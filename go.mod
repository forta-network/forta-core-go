...
// Fixes interface/struct problem with klog/logr
replace k8s.io/klog/v2 => k8s.io/klog/v2 v2.20.0

// Tries to fix opentelemetry failing tests
replace go.opentelemetry.io/otel/exporters/otlp/otlptrace => go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.11.1
