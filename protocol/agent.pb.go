...
var file_agent_proto_rawDesc = []byte{
	...
	0x6b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xf3, 0x05,
	...
	0x65, 0x76, 0x65, 0x72, 0x65, 0x73, 0x74, 0x49, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x65, 0x76, 0x65, 0x72, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x72,
	...
	0x69, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x1a, 0x3b, 0x0a, 0x0d, 0x4d, 0x65,
...
var file_agent_proto_goTypes = []interface{}{
	...
	nil,                                     // 18: network.forta.Finding.IndicatorsEntry
	nil,                                     // 19: network.forta.EvaluateTxResponse.MetadataEntry
	nil,                                     // 20: network.forta.EvaluateBlockResponse.MetadataEntry
	(*BlockEvent_Network)(nil),              // 21: network.forta.BlockEvent.Network
	(*BlockEvent_EthBlock)(nil),             // 22: network.forta.BlockEvent.EthBlock
	(*TransactionEvent_Network)(nil),        // 23: network.forta.TransactionEvent.Network
	(*TransactionEvent_EthBlock)(nil),       // 24: network.forta.TransactionEvent.EthBlock
	(*TransactionEvent_EthTransaction)(nil), // 25: network.forta.TransactionEvent.EthTransaction
	(*TransactionEvent_Log)(nil),            // 26: network.forta.TransactionEvent.Log
	(*TransactionEvent_EthReceipt)(nil),     // 27: network.forta.TransactionEvent.EthReceipt
	(*TransactionEvent_TraceAction)(nil),    // 28: network.forta.TransactionEvent.TraceAction
	(*TransactionEvent_TraceResult)(nil),    // 29: network.forta.TransactionEvent.TraceResult
	(*TransactionEvent_Trace)(nil),          // 30: network.forta.TransactionEvent.Trace
	nil,                                     // 31: network.forta.TransactionEvent.AddressesEntry
	nil,                                     // 32: network.forta.TransactionEvent.TxAddressesEntry
}
var file_agent_proto_depIdxs = []int32{
	...
	16, // 3: network.forta.EvaluateTxRequest.event:type_name -> network.forta.TransactionEvent
	15, // 4: network.forta.EvaluateBlockRequest.event:type_name -> network.forta.BlockEvent
	1,  // 5: network.forta.Finding.severity:type_name -> network.forta.Finding.Severity
	17, // 6: network.forta.Finding.metadata:type_name -> network.forta.Finding.MetadataEntry
	2,  // 7: network.forta.Finding.type:type_name -> network.forta.Finding.FindingType
	18, // 8: network.forta.Finding.indicators:type_name -> network.forta.Finding.IndicatorsEntry
	0,  // 9: network.forta.EvaluateTxResponse.status:type_name -> network.forta.ResponseStatus
	6,  // 10: network.forta.EvaluateTxResponse.errors:type_name -> network.forta.Error
	12, // 11: network.forta.EvaluateTxResponse.findings:type_name -> network.forta.Finding
	...
	6,  // 14: network.forta.EvaluateBlockResponse.errors:type_name -> network.forta.Error
	12, // 15: network.forta.EvaluateBlockResponse.findings:type_name -> network.forta.Finding
	...
	21, // 18: network.forta.BlockEvent.network:type_name -> network.forta.BlockEvent.Network
	22, // 19: network.forta.BlockEvent.block:type_name -> network.forta.BlockEvent.EthBlock
	...
	25, // 22: network.forta.TransactionEvent.transaction:type_name -> network.forta.TransactionEvent.EthTransaction
	27, // 23: network.forta.TransactionEvent.receipt:type_name -> network.forta.TransactionEvent.EthReceipt
	23, // 24: network.forta.TransactionEvent.network:type_name -> network.forta.TransactionEvent.Network
	30, // 25: network.forta.TransactionEvent.traces:type_name -> network.forta.TransactionEvent.Trace
	31, // 26: network.forta.TransactionEvent.addresses:type_name -> network.forta.TransactionEvent.AddressesEntry
	24, // 27: network.forta.TransactionEvent.block:type_name -> network.forta.TransactionEvent.EthBlock
	26, // 28: network.forta.TransactionEvent.logs:type_name -> network.forta.TransactionEvent.Log
	5,  // 29: network.forta.TransactionEvent.timestamps:type_name -> network.forta.TrackingTimestamps
	32, // 30: network.forta.TransactionEvent.txAddresses:type_name -> network.forta.TransactionEvent.TxAddressesEntry
	26, // 31: network.forta.TransactionEvent.EthReceipt.logs:type_name -> network.forta.TransactionEvent.Log
	28, // 32: network.forta.TransactionEvent.Trace.action:type_name -> network.forta.TransactionEvent.TraceAction
	29, // 33: network.forta.TransactionEvent.Trace.result:type_name -> network.forta.TransactionEvent.TraceResult
	7,  // 34: network.forta.Agent.Initialize:input_type -> network.forta.InitializeRequest
	10, // 35: network.forta.Agent.EvaluateTx:input_type -> network.forta.EvaluateTxRequest
	11, // 36: network.forta.Agent.EvaluateBlock:input_type -> network.forta.EvaluateBlockRequest
	8,  // 37: network.forta.Agent.Initialize:output_type -> network.forta.InitializeResponse
	13, // 38: network.forta.Agent.EvaluateTx:output_type -> network.forta.EvaluateTxResponse
	14, // 39: network.forta.Agent.EvaluateBlock:output_type -> network.forta.EvaluateBlockResponse
