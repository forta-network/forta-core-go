...
var file_agent_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x66, 0x6f, 0x72, 0x74, 0x61, 0x1a, 0x0e, 0x72, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x80, 0x01, 0x0a,
	...
	0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xf3, 0x05, 0x0a, 0x07, 0x46, 0x69, 0x6e, 0x64,
	...
	0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x12, 0x1c,
	0x0a, 0x09, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x09, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x12, 0x46, 0x0a, 0x0a,
	0x69, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x26, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x66, 0x6f, 0x72, 0x74, 0x61,
	0x2e, 0x46, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x2e, 0x49, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74,
	0x6f, 0x72, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0a, 0x69, 0x6e, 0x64, 0x69, 0x63, 0x61,
	...
	0x01, 0x1a, 0x3d, 0x0a, 0x0f, 0x49, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x45,
	...
	0x22, 0x5b, 0x0a, 0x0b, 0x46, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x0a, 0x08, 0x44, 0x45, 0x47, 0x52, 0x41, 0x44, 0x45, 0x44, 0x10, 0x03, 0x12, 0x0f, 0x0a, 0x0b,
	0x49, 0x4e, 0x46, 0x4f, 0x52, 0x4d, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x04, 0x22, 0x8d, 0x03,
	...
	0x10, 0x01, 0x32, 0x8f, 0x02, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x53, 0x0a, 0x0a,
...
var file_agent_proto_goTypes = []interface{}{
	(Finding_Severity)(0),                   // 0: network.forta.Finding.Severity
	(Finding_FindingType)(0),                // 1: network.forta.Finding.FindingType
	...
	(*InitializeRequest)(nil),               // 5: network.forta.InitializeRequest
	(*InitializeResponse)(nil),              // 6: network.forta.InitializeResponse
	(*EvaluateTxRequest)(nil),               // 7: network.forta.EvaluateTxRequest
	(*EvaluateBlockRequest)(nil),            // 8: network.forta.EvaluateBlockRequest
	(*Finding)(nil),                         // 9: network.forta.Finding
	...
	(*BlockEvent)(nil),                      // 12: network.forta.BlockEvent
	(*TransactionEvent)(nil),                // 13: network.forta.TransactionEvent
	nil,                                     // 14: network.forta.Finding.MetadataEntry
	nil,                                     // 15: network.forta.Finding.IndicatorsEntry
	...
	nil,                                     // 29: network.forta.TransactionEvent.TxAddressesEntry
	(ResponseStatus)(0),                     // 30: network.forta.ResponseStatus
	(*Error)(nil),                           // 31: network.forta.Error
}
var file_agent_proto_depIdxs = []int32{
	30, // 0: network.forta.InitializeResponse.status:type_name -> network.forta.ResponseStatus
	31, // 1: network.forta.InitializeResponse.errors:type_name -> network.forta.Error
	13, // 2: network.forta.EvaluateTxRequest.event:type_name -> network.forta.TransactionEvent
	12, // 3: network.forta.EvaluateBlockRequest.event:type_name -> network.forta.BlockEvent
	0,  // 4: network.forta.Finding.severity:type_name -> network.forta.Finding.Severity
	14, // 5: network.forta.Finding.metadata:type_name -> network.forta.Finding.MetadataEntry
	1,  // 6: network.forta.Finding.type:type_name -> network.forta.Finding.FindingType
	15, // 7: network.forta.Finding.indicators:type_name -> network.forta.Finding.IndicatorsEntry
	30, // 8: network.forta.EvaluateTxResponse.status:type_name -> network.forta.ResponseStatus
	31, // 9: network.forta.EvaluateTxResponse.errors:type_name -> network.forta.Error
	9,  // 10: network.forta.EvaluateTxResponse.findings:type_name -> network.forta.Finding
	16, // 11: network.forta.EvaluateTxResponse.metadata:type_name -> network.forta.EvaluateTxResponse.MetadataEntry
	30, // 12: network.forta.EvaluateBlockResponse.status:type_name -> network.forta.ResponseStatus
	31, // 13: network.forta.EvaluateBlockResponse.errors:type_name -> network.forta.Error
	9,  // 14: network.forta.EvaluateBlockResponse.findings:type_name -> network.forta.Finding
	17, // 15: network.forta.EvaluateBlockResponse.metadata:type_name -> network.forta.EvaluateBlockResponse.MetadataEntry
	2,  // 16: network.forta.BlockEvent.type:type_name -> network.forta.BlockEvent.EventType
	18, // 17: network.forta.BlockEvent.network:type_name -> network.forta.BlockEvent.Network
	19, // 18: network.forta.BlockEvent.block:type_name -> network.forta.BlockEvent.EthBlock
	4,  // 19: network.forta.BlockEvent.timestamps:type_name -> network.forta.TrackingTimestamps
	3,  // 20: network.forta.TransactionEvent.type:type_name -> network.forta.TransactionEvent.EventType
	...
	23, // 27: network.forta.TransactionEvent.logs:type_name -> network.forta.TransactionEvent.Log
	4,  // 28: network.forta.TransactionEvent.timestamps:type_name -> network.forta.TrackingTimestamps
	29, // 29: network.forta.TransactionEvent.txAddresses:type_name -> network.forta.TransactionEvent.TxAddressesEntry
	23, // 30: network.forta.TransactionEvent.EthReceipt.logs:type_name -> network.forta.TransactionEvent.Log
	25, // 31: network.forta.TransactionEvent.Trace.action:type_name -> network.forta.TransactionEvent.TraceAction
	26, // 32: network.forta.TransactionEvent.Trace.result:type_name -> network.forta.TransactionEvent.TraceResult
	5,  // 33: network.forta.Agent.Initialize:input_type -> network.forta.InitializeRequest
	7,  // 34: network.forta.Agent.EvaluateTx:input_type -> network.forta.EvaluateTxRequest
	8,  // 35: network.forta.Agent.EvaluateBlock:input_type -> network.forta.EvaluateBlockRequest
	6,  // 36: network.forta.Agent.Initialize:output_type -> network.forta.InitializeResponse
	10, // 37: network.forta.Agent.EvaluateTx:output_type -> network.forta.EvaluateTxResponse
	11, // 38: network.forta.Agent.EvaluateBlock:output_type -> network.forta.EvaluateBlockResponse
