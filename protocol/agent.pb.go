...
var file_agent_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xec, 0x04, 0x0a, 0x07, 0x46, 0x69, 0x6e, 0x64,
	...
	0x09, 0x52, 0x09, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x1a, 0x3b, 0x0a, 0x0d,
	...
	0x52, 0x49, 0x54, 0x49, 0x43, 0x41, 0x4c, 0x10, 0x05, 0x22, 0x5b, 0x0a, 0x0b, 0x46, 0x69, 0x6e,
	...
	0x54, 0x49, 0x4f, 0x4e, 0x10, 0x04, 0x22, 0x8d, 0x03, 0x0a, 0x12, 0x45, 0x76, 0x61, 0x6c, 0x75,
	0x61, 0x74, 0x65, 0x54, 0x78, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a,
	...
	0x6e, 0x64, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x4b, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b, 0x2e, 0x66, 0x6f, 0x72, 0x74, 0x61, 0x2e, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74,
	0x65, 0x54, 0x78, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x4d, 0x65, 0x74, 0x61,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x93, 0x03, 0x0a, 0x15, 0x45, 0x76, 0x61, 0x6c, 0x75,
	...
	0x08, 0x66, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x4e, 0x0a, 0x08, 0x6d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x6e, 0x65,
	...
	0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x9f, 0x07, 0x0a,
	...
	0x0d, 0x0a, 0x05, 0x52, 0x45, 0x4f, 0x52, 0x47, 0x10, 0x01, 0x1a, 0x02, 0x08, 0x01, 0x22, 0xb0,
	0x14, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x76,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x1a, 0x23, 0x0a, 0x07, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
...
var file_agent_proto_depIdxs = []int32{
	...
	23, // 25: network.forta.TransactionEvent.logs:type_name -> network.forta.TransactionEvent.Log
	23, // 26: network.forta.TransactionEvent.EthReceipt.logs:type_name -> network.forta.TransactionEvent.Log
	25, // 27: network.forta.TransactionEvent.Trace.action:type_name -> network.forta.TransactionEvent.TraceAction
	26, // 28: network.forta.TransactionEvent.Trace.result:type_name -> network.forta.TransactionEvent.TraceResult
	6,  // 29: network.forta.Agent.Initialize:input_type -> network.forta.InitializeRequest
	8,  // 30: network.forta.Agent.EvaluateTx:input_type -> network.forta.EvaluateTxRequest
	9,  // 31: network.forta.Agent.EvaluateBlock:input_type -> network.forta.EvaluateBlockRequest
	7,  // 32: network.forta.Agent.Initialize:output_type -> network.forta.InitializeResponse
	11, // 33: network.forta.Agent.EvaluateTx:output_type -> network.forta.EvaluateTxResponse
	12, // 34: network.forta.Agent.EvaluateBlock:output_type -> network.forta.EvaluateBlockResponse
