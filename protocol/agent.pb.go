...
var file_agent_proto_rawDesc = []byte{
	...
	0x9f, 0x07, 0x0a, 0x0a, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x37,
	...
	0x01, 0x22, 0xb0, 0x14, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f,
	...
	0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x1a, 0x23, 0x0a, 0x07, 0x4e, 0x65, 0x74, 0x77,
	...
	0x52, 0x47, 0x10, 0x01, 0x2a, 0x35, 0x0a, 0x0e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x0a, 0x07, 0x53, 0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x10, 0x02, 0x32, 0x8f, 0x02, 0x0a, 0x05,
...
var file_agent_proto_depIdxs = []int32{
	...
	23, // 19: network.forta.TransactionEvent.transaction:type_name -> network.forta.TransactionEvent.EthTransaction
	25, // 20: network.forta.TransactionEvent.receipt:type_name -> network.forta.TransactionEvent.EthReceipt
	21, // 21: network.forta.TransactionEvent.network:type_name -> network.forta.TransactionEvent.Network
	28, // 22: network.forta.TransactionEvent.traces:type_name -> network.forta.TransactionEvent.Trace
	29, // 23: network.forta.TransactionEvent.addresses:type_name -> network.forta.TransactionEvent.AddressesEntry
	22, // 24: network.forta.TransactionEvent.block:type_name -> network.forta.TransactionEvent.EthBlock
	24, // 25: network.forta.TransactionEvent.logs:type_name -> network.forta.TransactionEvent.Log
	24, // 26: network.forta.TransactionEvent.EthReceipt.logs:type_name -> network.forta.TransactionEvent.Log
	26, // 27: network.forta.TransactionEvent.Trace.action:type_name -> network.forta.TransactionEvent.TraceAction
	27, // 28: network.forta.TransactionEvent.Trace.result:type_name -> network.forta.TransactionEvent.TraceResult
	7,  // 29: network.forta.Agent.Initialize:input_type -> network.forta.InitializeRequest
	9,  // 30: network.forta.Agent.EvaluateTx:input_type -> network.forta.EvaluateTxRequest
	10, // 31: network.forta.Agent.EvaluateBlock:input_type -> network.forta.EvaluateBlockRequest
	8,  // 32: network.forta.Agent.Initialize:output_type -> network.forta.InitializeResponse
	12, // 33: network.forta.Agent.EvaluateTx:output_type -> network.forta.EvaluateTxResponse
	13, // 34: network.forta.Agent.EvaluateBlock:output_type -> network.forta.EvaluateBlockResponse
