...
type InspectionResults struct {
	...
	Indicators map[string]float64 `protobuf:"bytes,2,rep,name=indicators,proto3" json:"indicators,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"fixed64,2,opt,name=value,proto3"`
}
...
var file_batch_proto_rawDesc = []byte{
	...
	,
	...
	0x28, 0x01, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x0d, 0x5a,
...
var file_batch_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_batch_proto_goTypes = []interface{}{
	...
	nil,                            // 12: network.forta.InspectionResults.MetadataEntry
	nil,                            // 13: network.forta.InspectionResults.IndicatorsEntry
	(*Signature)(nil),              // 14: network.forta.Signature
	(Finding_Severity)(0),          // 15: network.forta.Finding.Severity
	(*AgentMetrics)(nil),           // 16: network.forta.AgentMetrics
	(*TransactionEvent)(nil),       // 17: network.forta.TransactionEvent
	(*SignedAlert)(nil),            // 18: network.forta.SignedAlert
	(*AgentInfo)(nil),              // 19: network.forta.AgentInfo
}
var file_batch_proto_depIdxs = []int32{
	...
	14, // 3: network.forta.SignedPayload.signature:type_name -> network.forta.Signature
	15, // 4: network.forta.AlertBatch.maxSeverity:type_name -> network.forta.Finding.Severity
	...
	16, // 7: network.forta.AlertBatch.metrics:type_name -> network.forta.AgentMetrics
	...
	17, // 14: network.forta.TransactionResults.transaction:type_name -> network.forta.TransactionEvent
	7,  // 15: network.forta.TransactionResults.results:type_name -> network.forta.AgentAlerts
	18, // 16: network.forta.AgentAlerts.alerts:type_name -> network.forta.SignedAlert
	19, // 17: network.forta.BatchAgent.info:type_name -> network.forta.AgentInfo
	12, // 18: network.forta.InspectionResults.metadata:type_name -> network.forta.InspectionResults.MetadataEntry
	13, // 19: network.forta.InspectionResults.indicators:type_name -> network.forta.InspectionResults.IndicatorsEntry
