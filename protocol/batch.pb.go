...
var file_batch_proto_rawDesc = []byte{
	...
	0x54, 0x10, 0x02, 0x22, 0xb3, 0x04, 0x0a, 0x0a, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x42, 0x61, 0x74,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x22, 0xb7, 0x01, 0x0a, 0x0c, 0x42, 0x6c,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x0d, 0x5a,
...
var file_batch_proto_goTypes = []interface{}{
	...
	(*SignedAlert)(nil),            // 15: network.forta.SignedAlert
	(*AgentInfo)(nil),              // 16: network.forta.AgentInfo
}
var file_batch_proto_depIdxs = []int32{
	...
	8,  // 10: network.forta.BlockResults.block:type_name -> network.forta.Block
	7,  // 11: network.forta.BlockResults.results:type_name -> network.forta.AgentAlerts
	6,  // 12: network.forta.BlockResults.transactions:type_name -> network.forta.TransactionResults
	14, // 13: network.forta.TransactionResults.transaction:type_name -> network.forta.TransactionEvent
	7,  // 14: network.forta.TransactionResults.results:type_name -> network.forta.AgentAlerts
	15, // 15: network.forta.AgentAlerts.alerts:type_name -> network.forta.SignedAlert
	16, // 16: network.forta.BatchAgent.info:type_name -> network.forta.AgentInfo
