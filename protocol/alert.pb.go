...
type BloomFilter struct {
	...
	Bitset []byte `protobuf:"bytes,3,opt,name=bitset,proto3" json:"bitset,omitempty"`
}
...
func (x *BloomFilter) GetBitset() []byte {
	if x != nil {
		return x.Bitset
	}
	return nil
...
var file_alert_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x62, 0x69, 0x74, 0x73, 0x65, 0x74, 0x22,
