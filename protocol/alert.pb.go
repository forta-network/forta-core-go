...
var file_alert_proto_rawDesc = []byte{
	...
	0x4a, 0x04, 0x08, 0x08, 0x10, 0x09, 0x2a, 0x5d, 0x0a, 0x09, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x16, 0x0a, 0x12, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x5f, 0x41,
	0x4c, 0x45, 0x52, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x10, 0x00, 0x12, 0x0f, 0x0a, 0x0b, 0x54,
	0x52, 0x41, 0x4e, 0x53, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05,
	0x42, 0x4c, 0x4f, 0x43, 0x4b, 0x10, 0x02, 0x12, 0x0b, 0x0a, 0x07, 0x50, 0x52, 0x49, 0x56, 0x41,
	0x54, 0x45, 0x10, 0x03, 0x12, 0x0f, 0x0a, 0x0b, 0x43, 0x4f, 0x4d, 0x42, 0x49, 0x4e, 0x41, 0x54,
	0x49, 0x4f, 0x4e, 0x10, 0x04, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74,
...
var file_alert_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_alert_proto_goTypes = []interface{}{
	...
	nil,                              // 15: network.forta.Alert.MetadataEntry
	nil,                              // 16: network.forta.Alert.TagsEntry
	(*Source_TransactionSource)(nil), // 17: network.forta.Source.TransactionSource
	(*Source_BlockSource)(nil),       // 18: network.forta.Source.BlockSource
	(*Source_URLSource)(nil),         // 19: network.forta.Source.URLSource
	(*Source_ChainSource)(nil),       // 20: network.forta.Source.ChainSource
	(*Source_AlertSource)(nil),       // 21: network.forta.Source.AlertSource
	(*Source_CustomSource)(nil),      // 22: network.forta.Source.CustomSource
	nil,                              // 23: network.forta.Finding.MetadataEntry
	nil,                              // 24: network.forta.Finding.IndicatorsEntry
}
var file_alert_proto_depIdxs = []int32{
	...
	15, // 3: network.forta.Alert.metadata:type_name -> network.forta.Alert.MetadataEntry
	5,  // 4: network.forta.Alert.agent:type_name -> network.forta.AgentInfo
	16, // 5: network.forta.Alert.tags:type_name -> network.forta.Alert.TagsEntry
	...
	17, // 12: network.forta.Source.transactions:type_name -> network.forta.Source.TransactionSource
	18, // 13: network.forta.Source.blocks:type_name -> network.forta.Source.BlockSource
	19, // 14: network.forta.Source.urls:type_name -> network.forta.Source.URLSource
	20, // 15: network.forta.Source.chains:type_name -> network.forta.Source.ChainSource
	21, // 16: network.forta.Source.alerts:type_name -> network.forta.Source.AlertSource
	22, // 17: network.forta.Source.customSources:type_name -> network.forta.Source.CustomSource
	2,  // 18: network.forta.Finding.severity:type_name -> network.forta.Finding.Severity
	23, // 19: network.forta.Finding.metadata:type_name -> network.forta.Finding.MetadataEntry
	3,  // 20: network.forta.Finding.type:type_name -> network.forta.Finding.FindingType
	24, // 21: network.forta.Finding.indicators:type_name -> network.forta.Finding.IndicatorsEntry
