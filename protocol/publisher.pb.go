...
var file_publisher_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x22, 0xa8, 0x04, 0x0a, 0x05, 0x41, 0x6c, 0x65,
	...
	0x73, 0x52, 0x0a, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x73, 0x1a, 0x3b, 0x0a,
	...
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x64, 0x57, 0x69, 0x74, 0x68, 0x54, 0x78, 0x22, 0x80, 0x04,
	...
	0x73, 0x65, 0x2a, 0x4c, 0x0a, 0x09, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x32, 0x58, 0x0a, 0x0d, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x72, 0x4e, 0x6f, 0x64,
	0x65, 0x12, 0x47, 0x0a, 0x06, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x1c, 0x2e, 0x6e, 0x65,
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x66, 0x6f, 0x72, 0x74, 0x61, 0x2e, 0x4e, 0x6f, 0x74, 0x69,
	0x66, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x6e, 0x65, 0x74, 0x77,
	0x6f, 0x72, 0x6b, 0x2e, 0x66, 0x6f, 0x72, 0x74, 0x61, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79,
...
var file_publisher_proto_goTypes = []interface{}{
	...
	(*EvaluateTxRequest)(nil),     // 13: network.forta.EvaluateTxRequest
	(*EvaluateTxResponse)(nil),    // 14: network.forta.EvaluateTxResponse
	(*EvaluateBlockRequest)(nil),  // 15: network.forta.EvaluateBlockRequest
...
var file_publisher_proto_depIdxs = []int32{
	...
	5,  // 8: network.forta.SignedAlert.alert:type_name -> network.forta.Alert
	4,  // 9: network.forta.SignedAlert.signature:type_name -> network.forta.Signature
	6,  // 10: network.forta.NotifyRequest.signedAlert:type_name -> network.forta.SignedAlert
	13, // 11: network.forta.NotifyRequest.evalTxRequest:type_name -> network.forta.EvaluateTxRequest
	14, // 12: network.forta.NotifyRequest.evalTxResponse:type_name -> network.forta.EvaluateTxResponse
	15, // 13: network.forta.NotifyRequest.evalBlockRequest:type_name -> network.forta.EvaluateBlockRequest
	16, // 14: network.forta.NotifyRequest.evalBlockResponse:type_name -> network.forta.EvaluateBlockResponse
	3,  // 15: network.forta.NotifyRequest.agentInfo:type_name -> network.forta.AgentInfo
	12, // 16: network.forta.NotifyRequest.timestamps:type_name -> network.forta.TrackingTimestamps
	7,  // 17: network.forta.PublisherNode.Notify:input_type -> network.forta.NotifyRequest
	8,  // 18: network.forta.PublisherNode.Notify:output_type -> network.forta.NotifyResponse
