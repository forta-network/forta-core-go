...
CONTRACT_REPO_ABI_PATH="$CONTRACT_REPO_NAME/.abis-no-errors/contracts/$CONTRACT_REPO_PARENT_DIR/$CONTRACT_NAME_TITLE_CASE.sol/$CONTRACT_NAME_TITLE_CASE.json"
...
CONTRACT_REPO_BIN_PATH="$CONTRACT_REPO_NAME/artifacts/contracts/$CONTRACT_REPO_PARENT_DIR/$CONTRACT_NAME_TITLE_CASE.sol/$CONTRACT_NAME_TITLE_CASE.json"
CURRENT_REPO_BIN_PATH="contracts/contract_$CONTRACT_NAME_SNAKE_CASE/$CONTRACT_NAME_TITLE_CASE.bin"
